...
class MSSC(nn.Module):
    ...
    def __init__(self, backbone, classifier):
        ...
        self.sap_1 = SingleAttributePrediction(num_classes=54, channels=512)
        self.sap_2 = SingleAttributePrediction(num_classes=54, channels=512)
        self.sap_3 = SingleAttributePrediction(num_classes=54, channels=512)
        self.sap_4 = SingleAttributePrediction(num_classes=54, channels=256)

        self.latlayer_1 = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)
        self.latlayer_2 = nn.Conv2d(512, 256, kernel_size=3, stride=1, padding=1)
        self.latlayer_3 = nn.Conv2d(1024, 256, kernel_size=3, stride=1, padding=1)
        self.latlayer_4 = nn.Conv2d(2048, 256, kernel_size=3, stride=1, padding=1)
    ...
    def fresh_params(self):
        params = chain(self.classifier.fresh_params(), self.sap_1.parameters(), self.sap_2.parameters(), self.sap_3.parameters(), self.sap_4.parameters(),
                       self.latlayer_1.parameters(), self.latlayer_2.parameters(), self.latlayer_3.parameters(), self.latlayer_4.parameters(),
                       self.msff_1.parameters(), self.msff_2.parameters(),self.msff_3.parameters(), self.msff_4.parameters(),
                       self.scc_1.parameters(), self.scc_2.parameters(), self.scc_3.parameters())
        return params
    ...
    def forward(self, x):
        feat_layer1, feat_layer2, feat_layer3, feat_layer4 = self.backbone(x)
        logits = self.classifier(feat_layer4)
        ...
        return pred_1, pred_2, pred_3, pred_4, logits
