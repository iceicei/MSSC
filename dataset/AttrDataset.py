...
class AttrDataset(data.Dataset):
    ...
    def __init__(self, split, args, transform=None, target_transform=None):
        ...
        # pickle file path, ex.pa100k dataset -> data_path='./dataset/data/PA100k/dataset.pkl'
        ...
        # dataset images folder path, ex.pa100k dataset path ->"./dataset/data/PA100k/data"
