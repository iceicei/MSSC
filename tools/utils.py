...
def return_attr_name_list(dataset_name):
    data_path = os.path.join("./dataset/data/", dataset_name, 'dataset.pkl')
    dataset_info = pickle.load(open(data_path, 'rb+'))
    return dataset_info.attr_name
